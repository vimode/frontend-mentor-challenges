  ...
  return (
    <div className="flex flex-col md:flex-row place-content-center gap-3 md:gap-4">
      <div className="relative">
        ...
        <input
          className="bg-midnight-neutral-800 px-6 py-4 pl-11 rounded-xl w-full text-midnight-neutral-200 placeholder-neutral-200"
          type="search"
          placeholder="Search for a place..."
        />
      </div>
      <button className="bg-royal-blue-500 px-6 py-4 rounded-xl">Search</button>
    </div>
  );
}
